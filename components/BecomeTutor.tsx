...
const steps = [
  ...
  },
  {
    ...
    icon: "/images/icon_training.png",
  },
  {
    title: "TRIAL PERIOD",
    description: "2-3 shadowing sessions where they observe, receive feedback, and refine their approach.",
    icon: "/images/icon_trail.png",
  },
  {
    title: "ONGOING SUPPORT",
    description: "Continued access to leadership and mentorship resources.",
        ...
        <div className="flex flex-col sm:flex-row items-start gap-2 md:gap-12 lg:gap-20">
          ...
          <div className="w-full flex flex-col gap-6 md:gap-8">
            ...
            <h2 className="text-ink font-rubik font-bold text-[28px] md:text-[34px] lg:text-[38px] xl:text-[42px] leading-[110%]">
              Become an Elementary or High School Tutor with Maslin Academy
            </h2>

            {/* Descriptive Paragraph */}
            <p className="text-ink font-rubik font-normal text-[14px] md:text-[16px] lg:text-[18px] leading-[160%]">
              Our tutors are mentors understand that great education happens when students feel seen, <span className="font-bold italic text-gold">SUPPORTED</span>, and <span className="font-bold italic text-gold">INSPIRED</span>.
            </p>
